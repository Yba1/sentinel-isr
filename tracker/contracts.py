"""Shared vocabulary and coercions for the three divergent Sentinel-ISR contracts.
...
loader, the Jac layer -- currently re-invents "what is a geofence, really?" at
...
project imports, no I/O, no network. That is the whole point -- the Jac layer and
